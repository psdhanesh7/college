...
// Problem Statement : Implement disk scheduling algorithm - CSCAN
...
void printHeadPointerMovementCSCAN(int requestQueue[], int n, int headPointer) {
    ...
    if(requests) {
		...
		headMovement += (2 * distEnd - distStart - currentPointer);
...
void main() {
    ...
    printHeadPointerMovementCSCAN(requestQueue, n, headPointer);
}
